...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, pretrained=True):
        ...
        self.finaldeconv1 = nn.Conv2d(filters[0], 32, 2, padding=1)
    ...
    def forward(self, x):
        ...
        #f1 = F.upsample(self.finaldeconv1(d1), scale_factor=2)
        f1 = self.finaldeconv1(F.upsample(d1, scale_factor=2))
