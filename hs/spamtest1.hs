...
mktree (f, s) = makeSimpleDecTree ginii f s

main 
    = do
        print $ "start"
        --print $ featsFromList ["k1", "k2"] ["k1", "k1", "2222", "k2"]
        --print $ massReplace [("1", "0"), ("2", "!")] "1 weweewewe 2 eefe 1 2"
        --print . mktree . readSpamData =<< readFile "spamdata" --"smallspam"
